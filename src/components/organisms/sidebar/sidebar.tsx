...
>(({ className, asChild = false, ...props }, ref) => {
  ...
  return (
    <Comp
      ...
      className={cn(
        "flex h-8 shrink-0 items-center rounded-lg px-2 text-xs font-medium text-sidebar-foreground/70 outline-none ring-sidebar-ring transition-all duration-200 ease-linear focus-visible:ring-2 [&>svg]:size-4 [&>svg]:shrink-0",
        "group-data-[collapsible=icon]:h-px group-data-[collapsible=icon]:w-6 group-data-[collapsible=icon]:mx-auto group-data-[collapsible=icon]:bg-border group-data-[collapsible=icon]:text-transparent group-data-[collapsible=icon]:p-0 group-data-[collapsible=icon]:my-2 group-data-[collapsible=icon]:overflow-hidden",
        className,
      )}
      {...props}
    />
...
>(({ className, ...props }, ref) => (
  <div
    ...
    className={cn(
      "pointer-events-none absolute right-1 flex h-5 min-w-5 select-none items-center justify-center rounded-full px-1 text-xs font-medium tabular-nums",
      "bg-destructive text-destructive-foreground",
      "peer-data-[size=sm]/menu-button:top-1",
      "peer-data-[size=default]/menu-button:top-1.5",
      "peer-data-[size=lg]/menu-button:top-2.5",
      "group-data-[collapsible=icon]:right-0.5 group-data-[collapsible=icon]:!top-0 group-data-[collapsible=icon]:scale-75",
      className,
    )}
    {...props}
  />
